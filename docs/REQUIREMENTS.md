...
CNP-Bot gives you the core functionality without that mess.
...
- Custom `cnp-bot` MCP server (inside container) provides scheduling tools
...
**CNP-Bot** - A reference to Clawdbot (now OpenClaw).
